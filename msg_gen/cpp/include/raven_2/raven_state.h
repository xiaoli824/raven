/* Auto-generated by genmsg_cpp for file /home/raven/xiao_wksp/raven_2/msg/raven_state.msg */
...
struct raven_state_ {
  ...
  typedef boost::array<int32_t, 16>  _current_cmd_type;
  boost::array<int32_t, 16>  current_cmd;
...
struct MD5Sum< ::raven_2::raven_state_<ContainerAllocator> > {
  ...
  {
    return "d2da96eb7a75b8ae96854119dcaf9448";
  }

  static const char* value(const  ::raven_2::raven_state_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xd2da96eb7a75b8aeULL;
  static const uint64_t static_value2 = 0x96854119dcaf9448ULL;
};
...
s << std::endl;
    ...
    s << indent << "current_cmd[]" << std::endl;
    for (size_t i = 0; i < v.current_cmd.size(); ++i)
    {
      s << indent << "  current_cmd[" << i << "]: ";
      Printer<int32_t>::stream(s, indent + "  ", v.current_cmd[i]);
    }
  }
};
